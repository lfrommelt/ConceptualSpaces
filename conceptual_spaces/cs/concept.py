...
class Concept:
    ...
    def membership_of(self, point):
        ...
        #print(self._weights['size'])
        #new_domains = self._domains
        ...
        '''    def membership_of_more_general(self, point):
        domainsubset = self._core.
        return self.project_onto(domainsubset).membership_of(point)'''
    ...
    def _between_integral(self, first, second, num_alpha_cuts):
        """Helper function for the integral-based betweenness."""
